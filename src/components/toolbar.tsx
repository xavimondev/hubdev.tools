...
export function Toolbar({ searchHistory, searchSuggestionsAI }: ToolbarProps) {
  ...
  return (
    <div
      className={cn(
        'flex flex-col fixed left-1/2 -translate-x-1/2 top-0 z-50 rounded-xl h-[50px] w-[min(420px,calc(100%_-_110px))] bg-gradient-to-br from-stone-800 to-neutral-900 translate-y-[8px] transition-multiple duration-300 shadow',
