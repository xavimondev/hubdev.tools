...
export function Hero({ title, description }: HeroProps) {
  return (
    <div className='relative flex items-center h-48'>
      ...
      <div className='absolute inset-0 bg-grid-light-900/30 dark:bg-grid-white/10 bg-grid-16 mask-[linear-gradient(180deg,black,transparent)]'></div>
      <div className='relative px-4'>
        <h1 className='text-2xl md:text-4xl text-balance font-bold bg-linear-to-br from-light-800 to-light-900 dark:from-white dark:to-white/50 bg-clip-text text-transparent category'>
          {title}
        </h1>
