  ...
  return (
    <div className='relative flex items-center h-48'>
      ...
      <div className='relative px-4'>
        <h1 className='bg-gradient-to-br from-light-800 to-light-900 dark:from-white dark:to-white/50 bg-clip-text text-3xl md:text-4xl xl:text-5xl text-transparent text-balance font-bold category'>
          {title}
        </h1>
